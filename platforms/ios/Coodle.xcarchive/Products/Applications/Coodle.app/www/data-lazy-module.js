            ...
            try {
                ...
                try {
                    ...
                    if ((this.isEditing && 'updated' in updateEntryResult && updateEntryResult.updated) ||
                        ...
                        if ((_d = updateEntryResult.generalnotifications) === null || _d === void 0 ? void 0 : _d.length) {
                            _services_utils_dom__WEBPACK_IMPORTED_MODULE_10__["CoreDomUtils"].showAlertWithOptions({
                                header: _singletons__WEBPACK_IMPORTED_MODULE_13__["Translate"].instant('core.notice'),
                                message: _services_utils_text__WEBPACK_IMPORTED_MODULE_19__["CoreTextUtils"].buildMessage(updateEntryResult.generalnotifications),
                                buttons: [_singletons__WEBPACK_IMPORTED_MODULE_13__["Translate"].instant('core.ok')],
                            });
                        }
                    }
                }
    ...
    ngOnInit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                this.sortDirection = (_a = _services_navigator__WEBPACK_IMPORTED_MODULE_7__["CoreNavigator"].getRouteParam('sortDirection')) !== null && _a !== void 0 ? _a : this.sortDirection;
                const sortBy = Number(_services_navigator__WEBPACK_IMPORTED_MODULE_7__["CoreNavigator"].getRouteParam('sortBy'));
    ...
    fetchEntryData(refresh = false, isPtr = false) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.entryHtml = _services_data_helper__WEBPACK_IMPORTED_MODULE_14__["AddonModDataHelper"].displayShowFields(template, this.fieldsArray, this.entry, _services_data__WEBPACK_IMPORTED_MODULE_13__["AddonModDataTemplateMode"].SHOW, actions, {
                    offset: this.offset,
                    sortBy: this.sortBy,
