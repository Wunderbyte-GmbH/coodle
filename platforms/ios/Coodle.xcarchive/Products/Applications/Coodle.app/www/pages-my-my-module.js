...
let CoreCoursesMyCoursesPage = class CoreCoursesMyCoursesPage {
    constructor(loadsManager) {
        ...
        this.updateSiteObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_11__["CoreEvents"].on(_singletons_events__WEBPACK_IMPORTED_MODULE_11__["CoreEvents"].SITE_UPDATED, () => {
     ...
     */
    loadSiteName() {
        this.siteName = _services_sites__WEBPACK_IMPORTED_MODULE_8__["CoreSites"].getRequiredCurrentSite().getSiteName() || '';
    }
    /**
