...
/* harmony import */ var _services_groups__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @services/groups */ "./src/core/services/groups.ts");
/* harmony import */ var _singletons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @singletons */ "./src/core/singletons/index.ts");
/* harmony import */ var _services_navigator__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @services/navigator */ "./src/core/services/navigator.ts");
...
/* harmony import */ var _classes_items_management_routed_items_manager_sources_tracker__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @classes/items-management/routed-items-manager-sources-tracker */ "./src/core/classes/items-management/routed-items-manager-sources-tracker.ts");
/* harmony import */ var _addons_calendar_classes_events_source__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @addons/calendar/classes/events-source */ "./src/addons/calendar/classes/events-source.ts");
/* harmony import */ var _classes_items_management_swipe_navigation_items_manager__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @classes/items-management/swipe-navigation-items-manager */ "./src/core/classes/items-management/swipe-navigation-items-manager.ts");
/* harmony import */ var _features_reminders_services_reminders__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @features/reminders/services/reminders */ "./src/core/features/reminders/services/reminders.ts");
/* harmony import */ var _features_reminders_components_set_reminder_menu_set_reminder_menu__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @features/reminders/components/set-reminder-menu/set-reminder-menu */ "./src/core/features/reminders/components/set-reminder-menu/set-reminder-menu.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonCalendarEventPage = class AddonCalendarEventPage {
    constructor(route) {
        ...
        this.isOnline = false;
        this.syncIcon = _core_constants__WEBPACK_IMPORTED_MODULE_18__["CoreConstants"].ICON_LOADING; // Sync icon.
        this.remindersEnabled = _features_reminders_services_reminders__WEBPACK_IMPORTED_MODULE_22__["CoreReminders"].isEnabled();
        ...
        this.onlineObserver = _services_network__WEBPACK_IMPORTED_MODULE_6__["CoreNetwork"].onChange().subscribe(() => {
            ...
            _singletons__WEBPACK_IMPORTED_MODULE_14__["NgZone"].run(() => {
        ...
        this.defaultTimeChangedObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].on(_features_reminders_services_reminders__WEBPACK_IMPORTED_MODULE_22__["CoreRemindersService"].DEFAULT_NOTIFICATION_TIME_CHANGED, () => {
            this.loadReminders();
        }, this.currentSiteId);
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                this.eventId = _services_navigator__WEBPACK_IMPORTED_MODULE_15__["CoreNavigator"].getRequiredRouteNumberParam('id');
            }
            catch (error) {
                _services_utils_dom__WEBPACK_IMPORTED_MODULE_8__["CoreDomUtils"].showErrorModal(error);
                _services_navigator__WEBPACK_IMPORTED_MODULE_15__["CoreNavigator"].back();
                return;
            }
    ...
    initializeSwipeManager() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const date = _services_navigator__WEBPACK_IMPORTED_MODULE_15__["CoreNavigator"].getRouteParam('date');
            const source = date && _classes_items_management_routed_items_manager_sources_tracker__WEBPACK_IMPORTED_MODULE_19__["CoreRoutedItemsManagerSourcesTracker"].getSource(_addons_calendar_classes_events_source__WEBPACK_IMPORTED_MODULE_20__["AddonCalendarEventsSource"], [date]);
            if (!source) {
                return;
            }
    ...
    loadGroupName(event, courseId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const groups = yield _services_groups__WEBPACK_IMPORTED_MODULE_13__["CoreGroups"].getUserGroupsInCourse(courseId);
    ...
    addReminder() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const reminderTime = yield _services_utils_dom__WEBPACK_IMPORTED_MODULE_8__["CoreDomUtils"].openPopover({
                component: _features_reminders_components_set_reminder_menu_set_reminder_menu__WEBPACK_IMPORTED_MODULE_23__["CoreRemindersSetReminderMenuComponent"],
                componentProps: {
    ...
    deleteReminder(id, e) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    yield _features_reminders_services_reminders__WEBPACK_IMPORTED_MODULE_22__["CoreReminders"].removeReminder(id);
                    yield this.loadReminders();
                }
                catch (error) {
    ...
    refreshEvent(sync = false, showErrors = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_16__["CoreUtils"].allPromisesIgnoringErrors(promises);
     ...
     */
    openEdit() {
        _services_navigator__WEBPACK_IMPORTED_MODULE_15__["CoreNavigator"].navigateToSitePath(`/calendar/edit/${this.eventId}`);
    }
    /**
     * Delete the event.
     */
    deleteEvent() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const title = _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.calendar.deleteevent');
            const options = {};
            let message;
            if (this.event.eventcount > 1) {
                // It's a repeated event.
                message = _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.calendar.confirmeventseriesdelete', { $a: { name: this.event.name, count: this.event.eventcount } });
                options.inputs = [
                    {
                        type: 'radio',
                        name: 'deleteall',
                        checked: true,
                        value: false,
                        label: _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.calendar.deleteoneevent'),
                    },
                    {
                        type: 'radio',
                        name: 'deleteall',
                        checked: false,
                        value: true,
                        label: _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.calendar.deleteallevents'),
                    },
                ];
            }
            else {
                // Not repeated, display a simple confirm.
                message = _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.calendar.confirmeventdelete', { $a: this.event.name });
            }
            let deleteAll = false;
            try {
 ...
 */
class AddonCalendarEventsSwipeItemsManager extends _classes_items_management_swipe_navigation_items_manager__WEBPACK_IMPORTED_MODULE_21__["CoreSwipeNavigationItemsManager"] {
    /**
     * @inheritdoc
     */
