...
/* harmony import */ var _features_filter_services_filter_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @features/filter/services/filter-helper */ "./src/core/features/filter/services/filter-helper.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
    ...
    ngOnInit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.title) {
                ...
                const filteredTitle = yield _features_filter_services_filter_helper__WEBPACK_IMPORTED_MODULE_5__["CoreFilterHelper"].getFiltersAndFormatText(this.title.trim(), 'module', (_b = (_a = this.module) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : -1, options, siteId);
