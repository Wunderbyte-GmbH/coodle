...
/* harmony import */ var _features_usertours_services_user_tours__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @features/usertours/services/user-tours */ "./src/core/features/usertours/services/user-tours.ts");
...
/* harmony import */ var _services_platform__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @services/platform */ "./src/core/services/platform.ts");
...
let CoreSettingsDevPage = class CoreSettingsDevPage {
    ...
    ngOnInit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.rtl = _services_platform__WEBPACK_IMPORTED_MODULE_6__["CorePlatform"].isRTL;
            this.RTLChanged();
            this.forceSafeAreaMargins = document.documentElement.classList.contains('force-safe-area-margins');
            this.safeAreaChanged();
            this.siteId = (_a = _services_sites__WEBPACK_IMPORTED_MODULE_7__["CoreSites"].getCurrentSite()) === null || _a === void 0 ? void 0 : _a.getId();
            if (!this.siteId) {
                return;
            }
            ...
            this.pluginStylesCount = 0;
            this.userToursEnabled = !_features_usertours_services_user_tours__WEBPACK_IMPORTED_MODULE_4__["CoreUserTours"].isDisabled();
            ...
            this.sitePlugins = _features_siteplugins_services_siteplugins__WEBPACK_IMPORTED_MODULE_3__["CoreSitePlugins"].getCurrentSitePluginList().map((plugin) => ({
                addon: plugin.addon,
                component: plugin.component,
                version: plugin.version,
            }));
            const disabledFeatures = (_c = (yield ((_b = _services_sites__WEBPACK_IMPORTED_MODULE_7__["CoreSites"].getCurrentSite()) === null || _b === void 0 ? void 0 : _b.getPublicConfig()))) === null || _c === void 0 ? void 0 : _c.tool_mobile_disabledfeatures;
     ...
     */
    copyInfo() {
        _services_utils_utils__WEBPACK_IMPORTED_MODULE_9__["CoreUtils"].copyToClipboard(JSON.stringify({ disabledFeatures: this.disabledFeatures, sitePlugins: this.sitePlugins }));
    }
    /**
    ...
    resetUserTours() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield _features_usertours_services_user_tours__WEBPACK_IMPORTED_MODULE_4__["CoreUserTours"].resetTours();
            yield _services_config__WEBPACK_IMPORTED_MODULE_5__["CoreConfig"].delete(_features_login_services_login_helper__WEBPACK_IMPORTED_MODULE_2__["CoreLoginHelperProvider"].ONBOARDING_DONE);
            _services_utils_dom__WEBPACK_IMPORTED_MODULE_8__["CoreDomUtils"].showToast('User tours have been reseted');
        });
    }
};
...
let CoreSettingsDeviceInfoPage = class CoreSettingsDeviceInfoPage {
    constructor() {
        ...
        this.deviceInfo.siteUrl = (currentSite === null || currentSite === void 0 ? void 0 : currentSite.getURL()) ||
            (typeof _core_constants__WEBPACK_IMPORTED_MODULE_2__["CoreConstants"].CONFIG.siteurl == 'string' && _core_constants__WEBPACK_IMPORTED_MODULE_2__["CoreConstants"].CONFIG.siteurl) || undefined;
        this.deviceInfo.isPrefixedUrl = !!_core_constants__WEBPACK_IMPORTED_MODULE_2__["CoreConstants"].CONFIG.siteurl;
