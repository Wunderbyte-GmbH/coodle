...
let CoreSitePluginsPluginPage = class CoreSitePluginsPluginPage {
    ...
    ngOnInit() {
        var _a, _b;
        this.comingFromCoodle = _services_navigator__WEBPACK_IMPORTED_MODULE_2__["CoreNavigator"].getRouteParam('comingFromCoodle');
        ...
        if ((_a = _services_navigator__WEBPACK_IMPORTED_MODULE_2__["CoreNavigator"].getRouteParam('title')) === null || _a === void 0 ? void 0 : _a.startsWith('plugin')) {
            // Translate didnt work -> Fallback
            this.title = (_b = _services_navigator__WEBPACK_IMPORTED_MODULE_2__["CoreNavigator"].getRouteParam('title')) === null || _b === void 0 ? void 0 : _b.replace('plugin', 'addon');
        }
        const test = _singletons__WEBPACK_IMPORTED_MODULE_7__["Translate"].currentLang;
        const trans = _singletons__WEBPACK_IMPORTED_MODULE_7__["Translate"].getTranslation('de').subscribe(res => console.log('lang', test, trans, res));
