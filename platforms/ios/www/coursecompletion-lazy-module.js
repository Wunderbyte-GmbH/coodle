...
let AddonCourseCompletionReportPage = class AddonCourseCompletionReportPage {
    ...
    fetchCompletion() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                this.user = yield _features_user_services_user__WEBPACK_IMPORTED_MODULE_3__["CoreUser"].getProfile(this.userId, this.courseId, true);
                ...
                if (error && error.errorcode == 'notenroled') {
                    ...
                    _services_utils_dom__WEBPACK_IMPORTED_MODULE_6__["CoreDomUtils"].showErrorModalDefault(error, 'addon.coursecompletion.couldnotloadreport', true);
                }
            }
        });
    }
    ...
    completeCourse() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const modal = yield _services_utils_dom__WEBPACK_IMPORTED_MODULE_6__["CoreDomUtils"].showModalLoading('core.sending', true);
            try {
