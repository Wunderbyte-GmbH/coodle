...
/* harmony import */ var _features_mainmenu_services_mainmenu_delegate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @features/mainmenu/services/mainmenu-delegate */ "./src/core/features/mainmenu/services/mainmenu-delegate.ts");
/* harmony import */ var _customservices_webservice_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/customservices/webservice.service */ "./src/customservices/webservice.service.ts");
...
/* harmony import */ var _addons_notifications_services_notifications__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @addons/notifications/services/notifications */ "./src/addons/notifications/services/notifications.ts");
/* harmony import */ var _features_mainmenu_services_mainmenu__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @features/mainmenu/services/mainmenu */ "./src/core/features/mainmenu/services/mainmenu.ts");
...
let CoodlelandingPage = class CoodlelandingPage {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            // });
            // Load the handlers.
            _features_user_services_user__WEBPACK_IMPORTED_MODULE_4__["CoreUser"].getUserPreference('coodleuser_chosen').then((setting) => {
                if (setting) {
            ...
            _singletons_events__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].on('USERSELECTED', () => {
                _features_user_services_user__WEBPACK_IMPORTED_MODULE_4__["CoreUser"].getUserPreference('coodleuser_chosen').then((setting) => {
                    if (setting) {
                        const settings = JSON.parse(setting);
                        if (settings.name) {
            ...
            _features_user_services_user__WEBPACK_IMPORTED_MODULE_4__["CoreUser"].getUserPreference('coodle_settings').then((setting) => {
                if (setting) {
                    const settings = JSON.parse(setting);
            ...
            this.subscription = _features_mainmenu_services_mainmenu_delegate__WEBPACK_IMPORTED_MODULE_5__["CoreMainMenuDelegate"].getHandlersObservable().subscribe((handlers) => {
                this.allHandlers = handlers;
            });
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_8__["CoreUtils"].ignoreErrors(_addons_notifications_services_notifications__WEBPACK_IMPORTED_MODULE_9__["AddonNotifications"].markAllNotificationsAsRead());
            // this.initHandlers();
        });
    }
    initHandlers() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.customItems = yield _features_mainmenu_services_mainmenu__WEBPACK_IMPORTED_MODULE_10__["CoreMainMenu"].getCustomMenuItems();
...
CoodlelandingPage.ctorParameters = () => [
    ...
    { type: _customservices_webservice_service__WEBPACK_IMPORTED_MODULE_6__["WebserviceService"] }
];
