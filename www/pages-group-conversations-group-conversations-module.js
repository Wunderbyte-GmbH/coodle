...
const mobileRoutes = [
    ...
    ..._addons_messages_messages_lazy_module__WEBPACK_IMPORTED_MODULE_4__["DISCUSSION_ROUTES"],
];
const tabletRoutes = [
    {
        path: '',
        ...
        component: _group_conversations_page__WEBPACK_IMPORTED_MODULE_7__["AddonMessagesGroupConversationsPage"],
        children: _addons_messages_messages_lazy_module__WEBPACK_IMPORTED_MODULE_4__["DISCUSSION_ROUTES"],
    },
];
const routes = [
...
AddonMessagesGroupConversationsPage.propDecorators = {
    ...
    completeListEl: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['completeList',] }],
