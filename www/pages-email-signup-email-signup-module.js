...
let CoreLoginEmailSignupPage = class CoreLoginEmailSignupPage {
    ...
    fetchData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                this.signupUrl = _singletons_path__WEBPACK_IMPORTED_MODULE_15__["CorePath"].concatenatePaths(this.siteConfig.httpswwwroot, 'login/signup.php');
     ...
     */
    showContactOnSite() {
        _services_utils_utils__WEBPACK_IMPORTED_MODULE_6__["CoreUtils"].openInBrowser(_singletons_path__WEBPACK_IMPORTED_MODULE_15__["CorePath"].concatenatePaths(this.siteUrl, '/login/verify_age_location.php'), { showBrowserWarning: false });
    }
    /**
     * Verify Age.
     *
