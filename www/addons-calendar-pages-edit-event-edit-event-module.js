            ...
            try {
                ...
                if (!this.typeControl.value) {
                    ...
                    if (this.types.course) {
                        this.typeControl.setValue(_services_calendar__WEBPACK_IMPORTED_MODULE_12__["AddonCalendarEventType"].GROUP);
                        console.log('test', _services_calendar__WEBPACK_IMPORTED_MODULE_12__["AddonCalendarEventType"].GROUP, this.courses[0].id);
